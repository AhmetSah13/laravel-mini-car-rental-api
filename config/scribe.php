...
return [
    ...
    'title' => 'Mini Car Rental API',

    // A short description of your API. Will be included in the docs webpage, Postman collection and OpenAPI spec.
    'description' => 'Laravel Sanctum token authentication kullanan mini araç kiralama API projesi.',
    ...
    'auth' => [
        ...
        // You can be able to use @unauthenticated or @authenticated on individual endpoints to change their status from the default.
        'default' => false,
    ...
    'strategies' => [
        ...
        'responses' => configureStrategy(
            ...
            Strategies\Responses\ResponseCalls::withSettings(
                only: ['GET api/brands', 'GET api/brands/*', 'GET api/cars', 'GET api/cars/*'],
                config: [
                    'app.debug' => false,
                ]
            )
